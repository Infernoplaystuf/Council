...
# ============================================================
# Produces dist/DatasInferno/DatasInferno and supporting files.
#
# Pre-reqs:
...
#
# The resulting dist/DatasInferno/ folder is fully self-contained.
...
echo " Executable:  $(pwd)/${bundle_path}/DatasInferno${exe_suffix}"
echo
echo " First-run setup on the target machine:"
echo "   1. Copy/extract dist/DatasInferno/ anywhere"
echo "   2. Run ./DatasInferno"
...
echo "   either:  tar -czf datas_inferno.tar.gz dist/DatasInferno/"
echo "============================================================"
