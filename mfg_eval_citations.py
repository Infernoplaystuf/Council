...
Run as a script:   python mfg_eval_citations.py
NOT importable — the body is guarded with __main__ so importing this
module no longer prints to stdout, reads from disk, or raises an
AssertionError when the mfg_eval corpus isn't installed.
"""
